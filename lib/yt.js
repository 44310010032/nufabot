...
const getVideoId = url => ytIdRegex.exec(url)[1]

const _mp3 = async (url) => new Promise(async (resolve, reject) => {
...
const mp3 = async(url) => {
    try {
        ...
        const videoInfo = await ytdl.getBasicInfo('https://www.youtube.com/watch?v=' + id, { lang: 'id' });
        let stream = ytdl(id, { filter: 'audioonly', quality: 140 });
